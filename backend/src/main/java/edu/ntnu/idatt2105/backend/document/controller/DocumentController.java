...
public class DocumentController {
  ...
  public DocumentDto uploadDocument(
    ...
    LOGGER.info(
        "Document create request: orgId={} userId={} name='{}' category={} module={} isLink={}",
        principal.getOrganizationId(), principal.getUserId(), name, category, module,
        externalUrl != null);
    return documentService.uploadDocument(file, externalUrl, name, description, category, module,
        expiryDate, principal);
  }
  ...
  public ResponseEntity<Resource> downloadDocument(
    ...
    JwtAuthenticatedPrincipal principal = JwtAuthenticatedPrincipal.from(auth);
    LOGGER.info("Document download: orgId={} documentId={}", principal.getOrganizationId(),
        documentId);
  ...
  public void deleteDocument(@PathVariable Long documentId, Authentication auth) {
    JwtAuthenticatedPrincipal principal = JwtAuthenticatedPrincipal.from(auth);
    LOGGER.info("Document delete: orgId={} documentId={}", principal.getOrganizationId(),
        documentId);
