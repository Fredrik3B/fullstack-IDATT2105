...
/**
 * A single temperature measurement enriched with zone and recorder metadata, used in the
 * temperature-log section of an {@link edu.ntnu.idatt2105.backend.report.dto.InspectionReport}.
 */
@Builder
