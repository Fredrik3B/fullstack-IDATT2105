 ...
 * temperature compliance statistics, as well as filtered list queries for the measurement history
 * view.
 */
public interface TemperatureMeasurementRepository extends
    JpaRepository<TemperatureMeasurementModel, Long> {
  ...
  List<TemperatureMeasurementModel> findAllByTask_IdInOrderByMeasuredAtDesc(
